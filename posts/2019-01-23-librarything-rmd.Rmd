---
title: "LibraryThing Reading Timeline"
...
``` {r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=12}
library(tidyverse)
library(ggrepel)
library(scales)
#Filter down to books finished since Dec 2017 when I started using date feature in LibThing
hasdate<-booksdf %>% mutate(date=as.Date(Finished_date,"%b %d, %Y")) %>% filter(!is.na(Finished_date) & date>="2017-12-01", Author != "Donald B. DeYoung") 
